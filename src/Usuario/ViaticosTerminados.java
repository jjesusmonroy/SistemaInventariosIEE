 ...
 * @author tepic
 */
public class ViaticosTerminados extends javax.swing.JFrame {

    /**
     * Creates new form ViaticosTerminados
     */
    public ViaticosTerminados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("VIATICOS SIN INFORME");
        ...
        jButton1.setText("REALIZAR INFORME");
        ...
        jLabel10.setText("CODIGO VIATICO SELECCIONADO");

        S.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        S.setForeground(new java.awt.Color(255, 51, 204));
        S.setText("x");

        jButton2.setText("INFORMES ENVIADOS");
    ...
    private void tablaAMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaAMouseClicked
        ...
        if(evt.getClickCount() == 1){
            ...
            S.setText(tablaA.getValueAt(fila, 0).toString());
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        ManejadorUsuario nuevo=new ManejadorUsuario();
        tablaA.setModel(nuevo.ViaticosTerminados(id.getText()));
        
    }//GEN-LAST:event_formWindowActivated

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         RedactarInforme info= new RedactarInforme();
         info.CambiaViatico(S.getText());
         info.cambiaEmpleado(id.getText());
        info.setVisible(true);
        
        
    }//GEN-LAST:event_jButton1ActionPerformed

    public void Atrapaid(String r){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViaticosTerminados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViaticosTerminados().setVisible(true);
            }
        });
    }
